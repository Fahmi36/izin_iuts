require([
  ...
  "dojo/domReady!",
   ...
   //  });
    ...
    //  URL lama
     url: "https://jakartasatu.jakarta.go.id/server/rest/services/JakartaSatu/Peta_Ops_V2_View/FeatureServer/3",
    ...
    locateBtn.on("locate", function(evt){
      ...
      $("#lon").val(evt.position.coords.longitude);
        ...
        dataRegis[0].lat = evt.position.coords.latitude;
        dataRegis[0].lng = evt.position.coords.longitude;
        localStorage.setItem("dataReqPermission", JSON.stringify(dataRegis));

        localStorage.setItem('kordinat', evt.position.coords.latitude+','+evt.position.coords.longitude);
    ...
    function clickpoint(evt) {
      ...
      if (evt[0].graphic.attributes == null) {
       ...
       localStorage.setItem('klb', evt[1].graphic.attributes['KLB']);
       localStorage.setItem('kdb', evt[1].graphic.attributes['KDB']);
       localStorage.setItem('kdh', evt[1].graphic.attributes['KDH']);
       ...
       localStorage.setItem('klb', evt[0].graphic.attributes['KLB']);
       localStorage.setItem('kdb', evt[0].graphic.attributes['KDB']);
       localStorage.setItem('kdh', evt[0].graphic.attributes['KDH']);
     }
   }
   // End Function Klik
});
